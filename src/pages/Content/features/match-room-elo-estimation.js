...
export const MatchRoomEloEstmation =  async parent => {
  ...
  // Select specific h6 elements under the correct parent divs
  const h6Elements = parent.querySelectorAll('h6')
  const factionNameElement1 = h6Elements[1] // second h6
  const factionNameElement2 = h6Elements[2] // third h6

  // Filter and process the factions
